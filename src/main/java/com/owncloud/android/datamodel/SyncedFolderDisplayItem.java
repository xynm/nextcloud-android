...
public class SyncedFolderDisplayItem extends SyncedFolder {
    ...
    public SyncedFolderDisplayItem(long id, String localPath, String remotePath, Boolean wifiOnly, Boolean chargingOnly,
                                   ...
                                   Boolean enabled, long timestampMs, List<String> filePaths, String folderName,
                                   long numberOfFiles, MediaFolderType type)
    {
    ...
    public SyncedFolderDisplayItem(long id, String localPath, String remotePath, Boolean wifiOnly, Boolean chargingOnly,
                                   Boolean existing, Boolean subfolderByDate, String account, Integer uploadAction,
                                   Boolean enabled, long timestampMs, String folderName, MediaFolderType type) {
        super(id, localPath, remotePath, wifiOnly, chargingOnly, existing, subfolderByDate, account, uploadAction,
              enabled, timestampMs, type);
        this.folderName = folderName;
    }
