...
public final class FilesSyncHelper {
    ...
    public static void insertAllDBEntriesForSyncedFolder(SyncedFolder syncedFolder, boolean syncNow) {
        ...
        if (syncedFolder.isEnabled() && (syncedFolder.getExisting() || enabledTimestampMs >= 0)) {
                ...
                try {
                    ...
                    Files.walkFileTree(path, new SimpleFileVisitor<Path>() {
                        ...
                        public FileVisitResult visitFile(Path path, BasicFileAttributes attrs) {
                            ...
                            if (syncedFolder.getExisting() || attrs.lastModifiedTime().toMillis() >= enabledTimestampMs) {
    ...
    private static void insertContentIntoDB(Uri uri, SyncedFolder syncedFolder) {
        ...
        if (cursor != null) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (syncedFolder.getExisting() || cursor.getLong(column_index_date_modified) >= enabledTimestampMs / 1000.0) {
